  ...
  return (
    <div className="searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]">
        <form action="">      
            ...
            rounded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700">
        ...
        <div className='secDiv flex items-center gap-10 justify-center'>
            <div className='singleSearch flex items-center gap-2'>
                ...
                <select name='' id='relevance' className='bg-white round-[3px] px-4 py-1'>
            ...
            <div className='singleSearch flex items-center gap-2'>
                ...
                <select name='' id='type' className='bg-white round-[3px] px-4 py-1'>
            ...
            <div className='singleSearch flex items-center gap-2'>
                ...
                <select name='' id='level' className='bg-white round-[3px] px-4 py-1'>
